...
int main(int argc, char* argv[]){
  ...
  string dyad_stringency_prefix = analysis_path + dyad_stringency_suffix;
  ...
  wig_ofstr<<track_name<<"\" description=\"dyad_stringency\" visibility=full color=202,73,170 priority=35 maxHeightPixels=50:50:11"<<endl;
